"""
This script will process a set of Vulnerabiltiy scan results, compare against a POAM Report and generate an updated POAM Report
...
SCAN_RESULTS_GENERATION_DAY = "07212020"
...
current_open_poam_file_path = "C:\\Users\\dhartman\\Documents\\FedRAMP\\Continuous Monitoring\\POAM\\{environment}\\05 - MAY\\".format(environment=ENVIRONMENT)
target_open_poam_file_path = "C:\\Users\\dhartman\\Documents\\FedRAMP\\Continuous Monitoring\\POAM\\{environment}\\07 - JUL\\".format(environment=ENVIRONMENT)


in_poam_file = "PTC CS -L5-POAM-Final-May-2020-Unmodified.xlsm"

out_poam_file = os.path.join(target_open_poam_file_path, "FedRAMP-FRM-POAM-June-2020_07_21.xlsm")
open_poam_worksheet_name = "Open POA&M Items"
closed_poam_worksheet_name = "Closed POA&M Items"
out_json_filename = "PTC_L5_CURRENT_POAMS.json"
...
if __name__ == "__main__":
    ...
    weekly_scan_results = ScanResults(in_scan_date="20200721",
    ...
    for scan_result in weekly_scan_results.scan_results:
        if not poam_recs_from_vuln_scan.get(scan_result.plugin):
            ...
            if scan_result_poam_id != "New POAM":
    ...
    poam_output_report = POAMReport(in_year="2020", in_month="7", report_name="L5-2020-07")
    ...
    poam_output_report.create_poam_excel_report_output(excel_report_output_file=out_poam_file)
